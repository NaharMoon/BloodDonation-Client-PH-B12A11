      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-sm opacity-70 max-w-2xl">
              Browse pending blood donation requests. Click view to see details (login required).
            </p>
          </div>
        ...
        {loading ? (
          ...
          <div className="mt-10 card-soft p-10 text-center">
            <h3 className="text-xl font-bold">No pending requests right now.</h3>
            <p className="mt-2 text-sm opacity-70">
              Please check again later. You can also register as a donor to help.
            </p>
